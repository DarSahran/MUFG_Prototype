...
import { Check, X, Star, Zap, Crown, TrendingUp, Users, Shield, Calculator, Bot, BarChart3, Globe } from 'lucide-react';
  ...
  const comparisonFeatures = [
    {
      ...
      features: [
        { name: 'Holdings Tracking', free: '5 holdings', pro: 'Unlimited', enterprise: 'Unlimited' },
        { name: 'Real-time Data', free: false, pro: true, enterprise: true },
        { name: 'Performance Analytics', free: 'Basic', pro: 'Advanced', enterprise: 'Institutional' },
        { name: 'Goal Tracking', free: '1 goal', pro: '10 goals', enterprise: 'Unlimited' },
      ]
    },
    {
      category: 'AI Features',
      features: [
        { name: 'AI Recommendations', free: '1/month', pro: '3/week', enterprise: 'Unlimited' },
        { name: 'Market Insights', free: 'Monthly', pro: 'Weekly', enterprise: 'Daily' },
        { name: 'Risk Analysis', free: 'Basic', pro: 'Advanced', enterprise: 'Institutional' },
        { name: 'Tax Optimization', free: false, pro: true, enterprise: true },
      ]
    },
    {
      category: 'Forecasting & Analysis',
      features: [
        { name: 'Retirement Calculator', free: 'Basic', pro: 'Advanced', enterprise: 'Custom' },
        { name: 'Monte Carlo Simulation', free: false, pro: true, enterprise: true },
        { name: 'Scenario Modeling', free: false, pro: '5 scenarios', enterprise: 'Unlimited' },
        { name: 'Benchmarking', free: false, pro: 'Market indices', enterprise: 'Custom benchmarks' },
      ]
    },
    {
      category: 'Support & Features',
      features: [
        { name: 'Support', free: 'Email', pro: 'Email + Chat', enterprise: 'Phone + Dedicated AM' },
        { name: 'Data Export', free: false, pro: 'PDF/Excel', enterprise: 'API + Custom' },
          ...
          >
            ...
            <button
              ...
              className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors ${
                billingCycle === 'yearly' ? 'bg-green-600' : 'bg-slate-300'
              }`}
            >
              <span
              ...
              >
                ...
                <div className="p-8">
                  ...
                  <div className="space-y-4 mb-8">
                    ...
                    {tier.features.limitations.map((limitation, limitIndex) => (
                ...
                {comparisonFeatures.map((category) => (
                  <React.Fragment key={category.category}>
                    <tr className="bg-slate-25">
                      <td colSpan={4} className="px-6 py-3 text-sm font-bold text-slate-800 bg-slate-100">
                        {category.category}
                      </td>
                    </tr>
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div>
              ...
              <p className="text-slate-600 mb-6">
                Pro plans include a 14-day free trial. Enterprise plans include a 30-day trial 
