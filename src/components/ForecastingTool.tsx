...
export const ForecastingTool: React.FC<ForecastingToolProps> = ({ userProfile }) => {
  ...
  // Utility function for currency formatting (must be above all usages)
      ...
      <div className="bg-white rounded-xl shadow-lg p-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {comparisonData.map((data, index) => (
            <div key={data.scenario} className={`p-4 rounded-lg border-2 ${index === 0 ? 'border-red-200 bg-red-50 hover:border-red-300' :
              ...
              <div className="flex items-center justify-between mb-2">
                ...
                <span className={`px-2 py-1 text-xs font-medium rounded-full ${index === 0 ? 'bg-red-100 text-red-700' :
              ...
              <div className="space-y-2">
                ...
                <div className="pt-2 border-t border-slate-200">
                  <div className={`flex items-center space-x-1 text-xs ${data.value >= retirementGoal ? 'text-green-600' : 'text-orange-600'
                    }`}>
    ...
    <div className="bg-white rounded-xl shadow-lg p-6">
      <div className="flex items-center justify-between mb-6">
        ...
        <button
          ...
          className={`flex items-center space-x-2 px-4 py-2 rounded-lg transition-colors ${showMonteCarlo ? 'bg-blue-600 text-white' : 'bg-slate-100 text-slate-600 hover:bg-slate-200'
            }`}
        >
